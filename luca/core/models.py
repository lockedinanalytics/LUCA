...
class Sport(str, Enum):
    MLB="mlb"; NFL="nfl"; NCAAF="ncaaf"; NBA="nba"; NHL="nhl"; SOCCER="soccer"; GOLF="golf"; TENNIS="tennis"; MMA="mma"
...
class MarketType(str, Enum):
    MONEYLINE="moneyline"; SPREAD="spread"; TOTAL="total"; TEAM_TOTAL="team_total"; PROP="prop"; FUTURE="future"; CONTEST="contest"
