...
from luca.providers.ncaaf.static_schedule import NcaafStaticScheduleProvider
from luca.providers.nfl.static_schedule import NflStaticScheduleProvider
...
def get_schedule_provider(name: str | None = None) -> ScheduleProvider:
    ...
    if selected == "nfl_static":
        return NflStaticScheduleProvider()
    if selected == "ncaaf_static":
        return NcaafStaticScheduleProvider()
